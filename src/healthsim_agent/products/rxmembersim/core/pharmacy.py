...
Ported from: healthsim-workspace/packages/rxmembersim/src/rxmembersim/core/pharmacy.py
"""
...
class PharmacyGenerator:
    ...
    def generate_mail_order(self, in_network: bool = True) -> Pharmacy:
        ...
        return self.generate(pharmacy_type=PharmacyType.MAIL_ORDER, chain=True, in_network=in_network)

    def generate_specialty(self, in_network: bool = True) -> Pharmacy:
        """Generate a specialty pharmacy."""
        return self.generate(pharmacy_type=PharmacyType.SPECIALTY, chain=True, in_network=in_network)

    def _generate_npi(self) -> str:
        """Generate a valid NPI."""
    ...
    def _generate_dea(self) -> str:
        ...
        first_letter = self.fake.random_element(["A", "B", "C", "D", "F", "G", "M", "P", "R"])
...
__all__ = ["PharmacyType", "Pharmacy", "PharmacyGenerator"]
