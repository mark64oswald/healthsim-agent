...
Ported from: healthsim-workspace/packages/rxmembersim/src/rxmembersim/core/prescriber.py
"""
...
class PrescriberGenerator:
    ...
    SPECIALTY_DEA_SUFFIX = {
        PrescriberSpecialty.PAIN_MANAGEMENT: "X",
    ...
    def generate(
        ...
        return Prescriber(
            ...
            practice_name=f"{self.fake.last_name()} {specialty.value} Associates" if self.fake.boolean(70) else None,
    ...
    def generate_specialist(self, specialty: PrescriberSpecialty) -> Prescriber:
...
__all__ = ["PrescriberType", "PrescriberSpecialty", "Prescriber", "PrescriberGenerator"]
