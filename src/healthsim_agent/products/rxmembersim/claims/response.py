...
Ported from: healthsim-workspace/packages/rxmembersim/src/rxmembersim/claims/response.py
"""
...
class DURResponseAlert(BaseModel):
    """Drug Utilization Review alert in response."""
...
class ClaimResponse(BaseModel):
    ...
    # DUR alerts
    dur_alerts: list[DURResponseAlert] = Field(default_factory=list)
...
__all__ = ["RejectCode", "DURResponseAlert", "ClaimResponse"]
