...
Ported from: healthsim-workspace/packages/patientsim/src/patientsim/core/reference_data.py
"""
...
COMMON_DIAGNOSES = [
    ...
    # Respiratory
    ICD10Code("J44.0", "COPD with acute lower respiratory infection", "respiratory"),
...
MEDICATIONS = [
    # Diabetes
    MedicationInfo("Metformin", "860975", ["500 mg", "850 mg", "1000 mg"], ["PO"], ["BID", "TID"], "Type 2 diabetes"),
    MedicationInfo("Insulin Glargine", "274783", ["10 units", "20 units", "30 units"], ["SubQ"], ["QD"], "Diabetes"),
    # Hypertension
    MedicationInfo("Lisinopril", "104376", ["5 mg", "10 mg", "20 mg", "40 mg"], ["PO"], ["QD"], "Hypertension"),
    MedicationInfo("Amlodipine", "17767", ["2.5 mg", "5 mg", "10 mg"], ["PO"], ["QD"], "Hypertension"),
    MedicationInfo("Hydrochlorothiazide", "5487", ["12.5 mg", "25 mg", "50 mg"], ["PO"], ["QD"], "Hypertension"),
    # Cardiac
    MedicationInfo("Atorvastatin", "83367", ["10 mg", "20 mg", "40 mg", "80 mg"], ["PO"], ["QD"], "Hyperlipidemia"),
    MedicationInfo("Aspirin", "1191", ["81 mg", "325 mg"], ["PO"], ["QD"], "CAD prophylaxis"),
    MedicationInfo("Metoprolol", "6918", ["25 mg", "50 mg", "100 mg"], ["PO"], ["BID"], "Hypertension/CAD"),
    # Respiratory
    MedicationInfo("Albuterol", "435", ["90 mcg/actuation"], ["INH"], ["PRN"], "Asthma/COPD"),
    MedicationInfo("Fluticasone", "202318", ["110 mcg/actuation", "220 mcg/actuation"], ["INH"], ["BID"], "Asthma/COPD"),
    # Infection
    MedicationInfo("Azithromycin", "18631", ["250 mg", "500 mg"], ["PO"], ["QD"], "Bacterial infection"),
    MedicationInfo("Ceftriaxone", "2193", ["1 g", "2 g"], ["IV"], ["Q24H"], "Bacterial infection"),
    MedicationInfo("Vancomycin", "11124", ["1 g", "1.5 g"], ["IV"], ["Q12H"], "MRSA/serious infection"),
]
