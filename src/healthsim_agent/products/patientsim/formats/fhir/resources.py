...
Ported from: healthsim-workspace/packages/patientsim/src/patientsim/formats/fhir/resources.py
"""
...
def create_codeable_concept(
    ...
    return CodeableConcept(coding=[create_coding(system, code, display)], text=text or display)
...
def get_loinc_code(test_name: str) -> tuple[str, str] | None:
    ...
    aliases = {
        "hgb": "hemoglobin", "hct": "hematocrit", "wbc_count": "wbc",
        "white_blood_cell": "wbc", "plt": "platelets", "na": "sodium",
        "k": "potassium", "cl": "chloride", "co2": "bicarbonate",
        "blood_urea_nitrogen": "bun", "cr": "creatinine", "glu": "glucose", "ca": "calcium",
    }
...
def get_vital_loinc(vital_type: str) -> tuple[str, str] | None:
    ...
    aliases = {
        "hr": "heart_rate", "pulse": "heart_rate", "rr": "respiratory_rate",
        "temp": "temperature", "sbp": "systolic_bp", "dbp": "diastolic_bp",
        "o2_sat": "spo2", "oxygen_saturation": "spo2", "ht": "height", "wt": "weight",
    }
...
__all__ = [
    "CodeableConcept", "Identifier", "Reference", "HumanName", "Period", "Quantity",
    "PatientResource", "EncounterResource", "ConditionResource", "ObservationResource",
    "BundleEntry", "Bundle", "CodeSystems",
    "create_coding", "create_codeable_concept", "get_loinc_code", "get_vital_loinc",
    "LOINC_MAPPINGS", "VITAL_SIGN_LOINC",
]
