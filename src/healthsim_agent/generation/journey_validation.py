...
Ported from: healthsim-workspace/packages/core/src/healthsim/generation/journey_validation.py
"""
...
class JourneySpecValidator:
    ...
    def _check_required_fields(self, spec: dict[str, Any], result: ValidationResult) -> None:
    ...
    def _check_events(self, events: list[dict], result: ValidationResult) -> None:
    ...
    def _check_delay(self, delay: dict[str, Any], result: ValidationResult, path: str) -> None:
    ...
    def _check_duration(self, duration: dict[str, Any], result: ValidationResult) -> None:
    ...
    def _check_triggers(self, triggers: list[dict], result: ValidationResult) -> None:
...
class TimelineValidator:
    ...
    def _check_chronological_order(self, events: list[dict], result: ValidationResult) -> None:
    ...
    def _check_event_completeness(self, events: list[dict], result: ValidationResult) -> None:
    ...
    def _check_date_validity(self, events: list[dict], result: ValidationResult) -> None:
...
class CrossEventValidator:
    ...
    def _setup_default_rules(self) -> None:
        ...
        self.add_rule("admission", "discharge", self._check_admission_before_discharge)
        self.add_rule("encounter", "claim", self._check_encounter_before_claim)
        self.add_rule("prescription", "fill", self._check_prescription_before_fill)
        self.add_rule("lab_order", "lab_result", self._check_order_before_result)
...
class JourneyValidator:
    ...
    def validate_specification(self, spec: dict[str, Any]) -> ValidationResult:
        """Validate a journey specification."""
        return self.spec_validator.validate(spec)
    
    def validate_timeline(self, timeline: Any) -> ValidationResult:
