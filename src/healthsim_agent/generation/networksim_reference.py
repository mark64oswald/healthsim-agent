...
Ported from: healthsim-workspace/packages/core/src/healthsim/generation/networksim_reference.py
"""
...
FACILITY_TYPE_MAP = {
    "hospital": "01",
    "long_term_hospital": "02",
    "psychiatric": "03",
    "rehabilitation": "04",
    "childrens": "05",
    "religious_nonmedical": "06",
    "snf": "07",
    "home_health": "08",
    "hospice": "09",
    "corf": "11",
...
def get_healthsim_db_path() -> Path:
    ...
    return workspace_root / "data" / "healthsim-reference.duckdb"
