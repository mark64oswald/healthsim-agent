...
Ported from: healthsim-workspace/packages/core/src/healthsim/generation/cross_domain_sync.py
"""
...
class TriggerRegistry:
    ...
    def __init__(self):
        ...
        self._specs: dict[TriggerType, CrossTriggerSpec] = {}
    
    def register_spec(self, spec: CrossTriggerSpec) -> None:
    ...
    def get_spec(self, trigger_type: TriggerType) -> CrossTriggerSpec | None:
...
class CrossDomainSync:
    ...
    def _setup_default_triggers(self) -> None:
        ...
        self.trigger_registry.register_spec(CrossTriggerSpec(
